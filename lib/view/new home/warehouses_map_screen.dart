...
import 'package:dhliz_app/models/home/marker_information_model.dart';
...
import '../../controllers/home/warehouses_controller.dart';
import '../../models/home/route_information.dart';
import '../home/self mangement of invntory/warehouse management/add warehouse/warehouse_details.dart';

class WarehousesMapScreen extends StatefulWidget {
  int space;
  bool dry;
  bool cold;
  bool freezing;
  ...
  @override
  _WarehousesMapScreenState createState() => _WarehousesMapScreenState();
}

class _WarehousesMapScreenState extends State<WarehousesMapScreen> {
  ...
  final _controller = WarehousesController.to;
