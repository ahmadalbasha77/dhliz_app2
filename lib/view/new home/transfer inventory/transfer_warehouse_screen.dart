...
class TransferWarehouseNewScreen extends StatefulWidget {
  ...
  @override
  State<TransferWarehouseNewScreen> createState() => _TransferWarehouseNewScreenState();
}

class _TransferWarehouseNewScreenState extends State<TransferWarehouseNewScreen> {
                ...
                child: InkWell(
                  onTap: () {
                    _controller.subscriptionsModel!.response[index]
                        ...
                        :
                    Get.to(() => TransferInventoryNewScreen(
                        id: _controller
