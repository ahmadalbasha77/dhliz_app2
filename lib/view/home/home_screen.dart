...
import 'account_monitoring_screen.dart';
import 'self mangement of invntory/self_management_of_inventory_screen.dart';
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Image.asset('image/home/$imagePath',
                width: screenSize.width * 0.3, cacheWidth: 200),
          ],
        ),
      ),
    );
