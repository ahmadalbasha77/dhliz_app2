...
class _MapScreenState extends State<MapScreen> {
  ...
  List<MarkerInfo> markerInfoList = [
    ...
    MarkerInfo(
      id: 'w3',
      position: LatLng(31.954752666488503, 35.84032582992194),
      title: 'مخزن 3',
      snippet: ' وصف مخزن 3',
      price: 300.0,
    ),
    // واكرر هذا النمط للمخازن الأخرى
    MarkerInfo(
      id: 'w4',
      position: LatLng(29.433710421851377, 35.049007557246014),
      title: 'مخزن 4',
      snippet: 'وصف المخزن 4',
      price: 400.0,
    ),
    MarkerInfo(
      id: 'w5',
      position: LatLng(29.29951188332875, 35.98372883859153),
      title: 'مخزن 5',
      snippet: 'وصف المخزن 5',
      price: 500.0,
    ),
    MarkerInfo(
      id: 'w6',
      position: LatLng(30.942413964186596, 37.26064745571876),
      title: 'مخزن 6',
      snippet: 'وصف المخزن 6',
      price: 600.0,
    ),
    MarkerInfo(
      id: 'w7',
      position: LatLng(32.540978884988164, 37.82269920336987),
      title: 'مخزن 7',
      snippet: 'وصف المخزن 7',
      price: 700.0,
    ),
    MarkerInfo(
      id: 'w8',
      position: LatLng(32.61076433669462, 35.74381361526875),
      title: 'مخزن 8',
      snippet: 'وصف المخزن 8',
      price: 800.0,
    ),
    MarkerInfo(
      id: 'w9',
      position: LatLng(30.234540780865554, 35.83876781535909),
      title: 'مخزن 9',
      snippet: 'وصف المخزن 9',
      price: 900.0,
    ),
    MarkerInfo(
      id: 'w10',
      position: LatLng(30.559375681490312, 36.07643053973427),
      title: 'مخزن 10',
      snippet: 'وصف المخزن 10',
      price: 1000.0,
    ),
  ];
    ...
    for (var markerInfo in markerInfoList) {
      markers.add(
        Marker(
          ...
          icon: customIcon1,
          // استخدم نفس الأيقونة المخصصة لجميع المتاجر
          infoWindow: InfoWindow(
            title: markerInfo.title,
            snippet: 'السعر: ${markerInfo.price.toString()} ',
          ),
          onTap: () {
            setState(() {
                                                      ...
                                                      builder: (context) =>
                                                          WarehouseDetails(
                                                              ...
                                                              distance: routeInfo
                                                                  ...
                                                                  .toStringAsFixed(
                                                                  2) ,
                                                              warehouseLocation:  selectWarehouse!.position,
