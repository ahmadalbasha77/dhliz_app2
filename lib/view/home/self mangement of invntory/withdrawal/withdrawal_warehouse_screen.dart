...
import 'package:dhliz_app/view/home/self%20mangement%20of%20invntory/withdrawal/withdrawal_invetory_screen.dart';
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Get.to(MapWarehouseScreen(
                                    ...
                                    lat: double.parse(item.address.lat),
                                    lon: double.parse(item.address.lot),
                                  ));
                                },
                                child: Text(
                                  'View map'.tr,
