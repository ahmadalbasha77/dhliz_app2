...
import 'package:dhliz_app/view/home/self%20mangement%20of%20invntory/withdrawal/withdrawal_stock_screen.dart';

import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';

class WithdrawalInventoryNewScreen extends StatefulWidget {
  final String id;

  const WithdrawalInventoryNewScreen({super.key, required this.id});

  @override
  State<WithdrawalInventoryNewScreen> createState() =>
      _WithdrawalInventoryNewScreenState();
}

class _WithdrawalInventoryNewScreenState
    extends State<WithdrawalInventoryNewScreen> {
