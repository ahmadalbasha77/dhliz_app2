...
class SixMonthsPackge extends StatefulWidget {
  const SixMonthsPackge({super.key});

  @override
  State<SixMonthsPackge> createState() => _SixMonthsPackgeState();
}

class _SixMonthsPackgeState extends State<SixMonthsPackge> {
  @override
