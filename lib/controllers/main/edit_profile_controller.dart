...
class EditProfileController extends GetxController {
  static EditProfileController get to => Get.isRegistered<EditProfileController>() ? Get.find<EditProfileController>() : Get.put(EditProfileController());
  ...
  selectImage() async {
    var result = await Utils.pickImages(allowMultiple: false, type: FileType.image);
